<div>
    <form wire:submit="save">
        ...
        <input id="image-name" type="text" wire:model="name" required>
        <label for="image-status">Status</label>
        <input id="image-status" type="text" wire:model="status" readonly aria-readonly="true">
        <label for="image-payload">Payload (JSON)</label>
        <textarea id="image-payload" wire:model="payload"></textarea>
