...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            ImageResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    public function transition(string $id, string $status): void
    {
        ...
        $record = $this->query()->findOrFail($id);
        app(TransitionImageResource::class)->execute($record, $teamId, $status);
    }

    public function render(): mixed
    {
        return view('module-automation-image-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return ImageResource::query()->when(
            $teamId === null,
