...
use Liberu\Modules\Automation\PromptRegistry\Actions\TransitionPromptRegistryResource;
use Liberu\Modules\Automation\PromptRegistry\Api\Support\ResourcePayload;
...
final class PromptRegistryResourceController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $resources = PromptRegistryResource::query()->forTeam($teamId)->latest()->paginate($pageSize, ['*'], 'page', $page);
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json(['data' => ResourcePayload::one(PromptRegistryResource::query()->forTeam($teamId)->findOrFail($id))]);
    }
    ...
    public function transition(Request $request, string $id, TransitionPromptRegistryResource $transition): JsonResponse
    {
