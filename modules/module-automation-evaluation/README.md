...
Provider-neutral Liberu Automation module for **quality suites, regression comparison, latency/cost metrics, safety checks, release gates**.
...
```bash
composer require liberusoftware/automation-evaluation
php artisan migrate
```
