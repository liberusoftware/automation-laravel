...
This runbook covers the provider-neutral `evaluation` module and its capabilities: quality suites, regression comparison, latency/cost metrics, safety checks, release gates.
...
```bash
composer require liberusoftware/evaluation
