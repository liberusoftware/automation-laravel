...
use Liberu\Modules\Automation\Evaluation\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Evaluation\Models\EvaluationResource;

final class TransitionEvaluationResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(EvaluationResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): EvaluationResource
    {
