...
use Liberu\Modules\Automation\AutomationCore\Events\ResourceTransitioned;
...
final class TransitionAutomationCoreResource
{
    ...
    public function execute(AutomationCoreResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): AutomationCoreResource
    {
