# Automation Core operations runbook

This runbook covers the provider-neutral `automation-core` module and its capabilities: workflow definitions, versions, triggers, state, runs, variables, schedules, retries, cancellation, compensation.
...
```bash
composer require liberusoftware/automation-core
