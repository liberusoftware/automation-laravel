...
use Liberu\Modules\Automation\DataProcessing\Actions\TransitionDataProcessingResource;
use Liberu\Modules\Automation\DataProcessing\Api\Support\ResourcePayload;
...
final class DataProcessingResourceController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $resources = DataProcessingResource::query()->forTeam($teamId)->latest()->paginate($pageSize, ['*'], 'page', $page);
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json(['data' => ResourcePayload::one(DataProcessingResource::query()->forTeam($teamId)->findOrFail($id))]);
    }
    ...
    public function transition(Request $request, string $id, TransitionDataProcessingResource $transition): JsonResponse
    {
