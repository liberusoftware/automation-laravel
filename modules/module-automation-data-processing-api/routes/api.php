...
Route::middleware(['api', 'auth:sanctum', 'throttle:60,1'])->prefix('api/v1/automation/data-processing')->group(function (): void {
    ...
    Route::post('/{id}/transition', [DataProcessingResourceController::class, 'transition']);
});
