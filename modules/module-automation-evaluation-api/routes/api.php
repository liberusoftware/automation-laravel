...
Route::middleware(['api', 'auth:sanctum', 'throttle:60,1'])->prefix('api/v1/automation/evaluation')->group(function (): void {
    ...
    Route::post('/{id}/transition', [EvaluationResourceController::class, 'transition']);
});
