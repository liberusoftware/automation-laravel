# Approvals operations runbook

This runbook covers the provider-neutral `approvals` module and its capabilities: human review queues, separation of duties, expiry, escalation, delegation, evidence.
...
```bash
composer require liberusoftware/approvals
