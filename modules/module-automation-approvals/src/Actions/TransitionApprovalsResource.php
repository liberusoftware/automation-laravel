...
use Liberu\Modules\Automation\Approvals\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Approvals\Models\ApprovalsResource;

final class TransitionApprovalsResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(ApprovalsResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): ApprovalsResource
    {
