...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            DataProcessingResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    public function transition(string $id, string $status): void
    {
        ...
        $record = $this->query()->findOrFail($id);
        app(TransitionDataProcessingResource::class)->execute($record, $teamId, $status);
    }

    public function render(): mixed
    {
        return view('module-automation-data-processing-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return DataProcessingResource::query()->when(
            $teamId === null,
