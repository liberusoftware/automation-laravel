<div>
    <form wire:submit="save">
        <label for="data-processing-name">Name</label>
        <input id="data-processing-name" type="text" wire:model="name" required>
        <label for="data-processing-status">Status</label>
        <input id="data-processing-status" type="text" wire:model="status" readonly aria-readonly="true">
        <label for="data-processing-payload">Payload (JSON)</label>
        <textarea id="data-processing-payload" wire:model="payload"></textarea>
