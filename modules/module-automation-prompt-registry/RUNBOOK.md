# Prompt Registry operations runbook

This runbook covers the provider-neutral `prompt-registry` module and its capabilities: versioned prompts, variables, evaluation sets, tenant overrides, approvals, rollback.
...
```bash
composer require liberusoftware/prompt-registry
