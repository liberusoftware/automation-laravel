...
use Liberu\Modules\Automation\PromptRegistry\Events\ResourceTransitioned;
...
final class TransitionPromptRegistryResource
{
    ...
    public function execute(PromptRegistryResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): PromptRegistryResource
    {
