...
Provider-neutral Liberu Automation module for **versioned prompts, variables, evaluation sets, tenant overrides, approvals, rollback**.
...
```bash
composer require liberusoftware/automation-prompt-registry
php artisan migrate
```
