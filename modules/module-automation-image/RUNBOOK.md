# Image operations runbook

This runbook covers the provider-neutral `image` module and its capabilities: generation requests, editing requests, source assets, moderation, provenance, variants, delivery.
...
```bash
composer require liberusoftware/image
