...
use Liberu\Modules\Automation\Voice\Actions\TransitionVoiceResource;
use Liberu\Modules\Automation\Voice\Api\Support\ResourcePayload;
...
final class VoiceResourceController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $resources = VoiceResource::query()->forTeam($teamId)->latest()->paginate($pageSize, ['*'], 'page', $page);
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json(['data' => ResourcePayload::one(VoiceResource::query()->forTeam($teamId)->findOrFail($id))]);
    }
    ...
    public function transition(Request $request, string $id, TransitionVoiceResource $transition): JsonResponse
    {
