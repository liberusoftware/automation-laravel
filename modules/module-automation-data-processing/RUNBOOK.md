# Data Processing operations runbook

This runbook covers the provider-neutral `data-processing` module and its capabilities: classification, extraction, summarization, translation, enrichment, redaction, batch processing.
...
```bash
composer require liberusoftware/data-processing
