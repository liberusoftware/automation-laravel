...
use Liberu\Modules\Automation\DataProcessing\Events\ResourceTransitioned;
...
final class TransitionDataProcessingResource
{
    ...
    public function execute(DataProcessingResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): DataProcessingResource
    {
