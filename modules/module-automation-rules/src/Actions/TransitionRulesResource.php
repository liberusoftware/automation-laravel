...
use Liberu\Modules\Automation\Rules\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Rules\Models\RulesResource;

final class TransitionRulesResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(RulesResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): RulesResource
    {
