...
This runbook covers the provider-neutral `rules` module and its capabilities: typed conditions, expressions, validation, simulation, decision tables.
...
```bash
composer require liberusoftware/rules
