...
Route::middleware(['api', 'auth:sanctum', 'throttle:60,1'])->prefix('api/v1/automation/image')->group(function (): void {
    ...
    Route::post('/{id}/transition', [ImageResourceController::class, 'transition']);
});
