...
This runbook covers the provider-neutral `voice` module and its capabilities: speech-to-text, text-to-speech, streaming sessions, interruption, transcripts, consent controls.
...
```bash
composer require liberusoftware/voice
