...
use Liberu\Modules\Automation\Voice\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Voice\Models\VoiceResource;

final class TransitionVoiceResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(VoiceResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): VoiceResource
    {
