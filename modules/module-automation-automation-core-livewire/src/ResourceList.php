...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            AutomationCoreResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    public function transition(string $id, string $status): void
    {
        ...
        $record = $this->query()->findOrFail($id);
        app(TransitionAutomationCoreResource::class)->execute($record, $teamId, $status);
    }

    public function render(): mixed
    {
        return view('module-automation-automation-core-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return AutomationCoreResource::query()->when(
            $teamId === null,
