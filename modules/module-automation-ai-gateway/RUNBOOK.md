...
This runbook covers the provider-neutral `ai-gateway` module and its capabilities: provider contracts, model catalog, routing, fallback, structured output, tool policy, usage metering.
...
```bash
composer require liberusoftware/ai-gateway
