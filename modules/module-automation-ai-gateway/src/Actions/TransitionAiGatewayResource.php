...
use Liberu\Modules\Automation\AiGateway\Events\ResourceTransitioned;
use Liberu\Modules\Automation\AiGateway\Models\AiGatewayResource;

final class TransitionAiGatewayResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(AiGatewayResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): AiGatewayResource
    {
