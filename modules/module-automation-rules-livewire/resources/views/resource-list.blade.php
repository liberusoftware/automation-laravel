<div>
    <form wire:submit="save">
        ...
        <input id="rules-name" type="text" wire:model="name" required>
        <label for="rules-status">Status</label>
        <input id="rules-status" type="text" wire:model="status" readonly aria-readonly="true">
        <label for="rules-payload">Payload (JSON)</label>
        <textarea id="rules-payload" wire:model="payload"></textarea>
