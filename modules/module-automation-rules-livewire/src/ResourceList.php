...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            RulesResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    public function transition(string $id, string $status): void
    {
        ...
        $record = $this->query()->findOrFail($id);
        app(TransitionRulesResource::class)->execute($record, $teamId, $status);
    }

    public function render(): mixed
    {
        return view('module-automation-rules-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return RulesResource::query()->when(
            $teamId === null,
