...
use Liberu\Modules\Automation\Connectors\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Connectors\Models\ConnectorsResource;

final class TransitionConnectorsResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(ConnectorsResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): ConnectorsResource
    {
