...
Provider-neutral Liberu Automation module for **authenticated triggers/actions, webhooks, rate limits, cursor sync, replay, reconciliation**.
...
```bash
composer require liberusoftware/module-automation-connectors
php artisan migrate
```
