<div>
    <form wire:submit="save">
        <label for="approvals-name">Name</label>
        <input id="approvals-name" type="text" wire:model="name" required>
        <label for="approvals-status">Status</label>
        <input id="approvals-status" type="text" wire:model="status" readonly aria-readonly="true">
        <label for="approvals-payload">Payload (JSON)</label>
        <textarea id="approvals-payload" wire:model="payload"></textarea>
