...
This runbook covers the provider-neutral `video` module and its capabilities: generation jobs, editing jobs, scripts, captions, audio, moderation, provenance, delivery.
...
```bash
composer require liberusoftware/video
