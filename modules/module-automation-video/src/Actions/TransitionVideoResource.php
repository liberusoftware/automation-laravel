...
use Liberu\Modules\Automation\Video\Events\ResourceTransitioned;
use Liberu\Modules\Automation\Video\Models\VideoResource;

final class TransitionVideoResource
{
    /** @param list<string> $allowedStatuses */
    public function execute(VideoResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled'], ?string $actorId = null, ?string $correlationId = null): VideoResource
    {
