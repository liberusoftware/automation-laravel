...
This package is the one-to-one **livewire** presentation adapter for `liberusoftware/liberu-platform-orchestration`.
...
- Composer package: `liberusoftware/liberu-platform-orchestration-livewire`
