...
use Liberu\Modules\Automation\Approvals\Api\Support\ResourcePayload;
...
final class ApprovalsResourceController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $resources = ApprovalsResource::query()->forTeam($teamId)->latest()->paginate($pageSize, ['*'], 'page', $page);
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json(['data' => ResourcePayload::one(ApprovalsResource::query()->forTeam($teamId)->findOrFail($id))]);
    }
    ...
    public function transition(Request $request, string $id, TransitionApprovalsResource $transition): JsonResponse
    {
